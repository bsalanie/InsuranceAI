...
__all__ = [
    "DATA_PATH",
    "GENERAL_RESULTS_FOLDER",
    "PDF_FOLDER",
    "DASH",
    "PARAMETERS",
    "VARIABLE_RHO_NOTEBOOK_PATH_NO_EXTENSION",
    "CONSTANT_RHO_NOTEBOOK_PATH_NO_EXTENSION",
    "ACCUMULATED_CONSTANT_RO_DATA_PATH",
    "PREDICTING_FHAT_ACCURACIES_DATA_PATH",
    "PREDICTING_FHAT_NOTEBOOK_HTML_PATH",
    "PREDICTING_FHAT_SEE_RESULTS_NO_EXTENSION",
    "ACCUMULATED_DATA_SEE_RESULTS_NO_EXTENSION",
    "read_data",
    "select_variables",
]
...
def read_data(dataset: str) -> pd.DataFrame:  # "j88" or "jpropre"  # a clean data frame
    """
...
def select_variables(
    data: pd.DataFrame,  # the Pandas data frame
